...
def standardize_semester_key(semester_key):
    ...
    canonical_mappings = {
        ...
        ("BN", "YEAR", "1", "SEMESTER", "1"): "BN-FIRST-YEAR-FIRST-SEMESTER",
        
        # BN First Year Second Semester variants
        ("BN", "FIRST", "YEAR", "SECOND", "SEMESTER"): "BN-FIRST-YEAR-SECOND-SEMESTER",
        ("BN", "1ST", "YEAR", "2ND", "SEMESTER"): "BN-FIRST-YEAR-SECOND-SEMESTER",
        ("BN", "YEAR", "1", "SEMESTER", "2"): "BN-FIRST-YEAR-SECOND-SEMESTER",
        
        # BN Second Year First Semester variants
        ("BN", "SECOND", "YEAR", "FIRST", "SEMESTER"): "BN-SECOND-YEAR-FIRST-SEMESTER",
        ("BN", "2ND", "YEAR", "1ST", "SEMESTER"): "BN-SECOND-YEAR-FIRST-SEMESTER",
        ("BN", "YEAR", "2", "SEMESTER", "1"): "BN-SECOND-YEAR-FIRST-SEMESTER",
        
        # BN Second Year Second Semester variants
        ("BN", "SECOND", "YEAR", "SECOND", "SEMESTER"): "BN-SECOND-YEAR-SECOND-SEMESTER",
        ("BN", "2ND", "YEAR", "2ND", "SEMESTER"): "BN-SECOND-YEAR-SECOND-SEMESTER",
        ("BN", "YEAR", "2", "SEMESTER", "2"): "BN-SECOND-YEAR-SECOND-SEMESTER",

        # BN Third Year First Semester variants
        ("BN", "THIRD", "YEAR", "FIRST", "SEMESTER"): "BN-THIRD-YEAR-FIRST-SEMESTER",
        ("BN", "3RD", "YEAR", "1ST", "SEMESTER"): "BN-THIRD-YEAR-FIRST-SEMESTER",
        ("BN", "YEAR", "3", "SEMESTER", "1"): "BN-THIRD-YEAR-FIRST-SEMESTER",

        # BN Third Year Second Semester variants
        ("BN", "THIRD", "YEAR", "SECOND", "SEMESTER"): "BN-THIRD-YEAR-SECOND-SEMESTER",
        ("BN", "3RD", "YEAR", "2ND", "SEMESTER"): "BN-THIRD-YEAR-SECOND-SEMESTER",
...
def get_previous_semester(semester_key):
    ...
    if standardized == "BN-FIRST-YEAR-SECOND-SEMESTER":
        ...
        return "BN-FIRST-YEAR-SECOND-SEMESTER"
    elif standardized == "BN-SECOND-YEAR-SECOND-SEMESTER":
        return "BN-SECOND-YEAR-FIRST-SEMESTER"
    elif standardized == "BN-THIRD-YEAR-FIRST-SEMESTER":
        return "BN-SECOND-YEAR-SECOND-SEMESTER"
    elif standardized == "BN-THIRD-YEAR-SECOND-SEMESTER":
        return "BN-THIRD-YEAR-FIRST-SEMESTER"
    else:
